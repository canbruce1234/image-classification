...
<div id="header" style="display: block;">
  ...
  <div id="ipython_notebook" class="nav navbar-brand pull-left"><a href="http://54.197.23.25:8888/tree" title="dashboard"><img src="problem_unittests_files/logo.png" alt="Jupyter Notebook"></a></div>
